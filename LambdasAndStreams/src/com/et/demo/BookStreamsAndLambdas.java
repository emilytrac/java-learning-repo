...
public class BookStreamsAndLambdas {
	public static void main(String[] args) {
		...
		// filtering books by Author A and then counting total amount
		...
		// collecting and then printing all books written by author A
